...
protein1 = [273, 412, 484, 374, 389, 385, 376, 372, 483, 483, 400, 412, 377, 173, 385, 392, 367, 412, 337, 400, 412, 307, 409, 372, 375, 367, 406, 396, 405, 173, 400, 413, 350, 173, 313, 396, 417, 372, 342, 372, 403, 375, 408, 405, 374, 181, 406, 354, 370, 276, 389, 343] #test data
protein2 = [186, 209, 216, 71, 59, 62, 71, 77, 216, 206, 47, 182, 66, 209, 66, 58, 65, 184, 173, 51, 208, 71, 175, 79, 66, 62, 44, 55, 110, 173, 48, 175, 108, 182, 90, 51, 209, 68, 189, 69, 107, 65, 114, 111, 77, 135, 47, 97, 65, 209, 62, 112]
evscore = [3.78, 2.56, 2.35, 2.34, 2.23, 2.18, 2.05, 1.82, 1.76, 1.74, 1.72, 1.7, 1.69, 1.67, 1.62, 1.58, 1.56, 1.49, 1.46, 1.42, 1.4, 1.37, 1.3, 1.28, 1.24, 1.24, 1.2, 1.18, 1.17, 1.16, 1.16, 1.15, 1.14, 1.14, 1.1, 1.08, 1.06, 1.04, 1.03, 1.03, 1.03, 1.02, 1.0, 1.0, 0.99, 0.99, 0.98, 0.98, 0.98, 0.97, 0.95, 0.94]
...
protein1 = [248, 259, 252, 255, 252, 214, 210, 252, 240, 210, 262] #test data
protein2 = [42, 130, 137, 141, 141, 24, 31, 46, 35, 24, 137]
evscore = [3.4, 1.96, 1.85, 1.79, 1.36, 1.17, 1.16, 1.14, 1.09, 1.08, 0.96]
for i in range(len(protein1)): #loops through a list of coev pairs and their scores
...
mc1=IMP.pmi.macros.ReplicaExchange0(mdl,
                                    ...
                                    global_output_directory="/home/cns-mccafferty/Ecoli_CoEv_modeling/CoEv_IMP/1fft/20cutoff/run1/output/")
