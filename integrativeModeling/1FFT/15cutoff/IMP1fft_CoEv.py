...
protein1 = [273, 412, 484, 374, 389, 385, 376, 372, 483, 483, 400, 412, 377, 173, 385, 392, 367, 412, 337, 400, 412, 307, 409, 372, 375, 367, 406, 396, 173, 400] #test data
protein2 = [186, 209, 216, 71, 59, 62, 71, 77, 216, 206, 47, 182, 66, 209, 66, 58, 65, 184, 173, 51, 208, 71, 175, 79, 66, 62, 44, 55, 173, 48]
evscore = [3.78, 2.56, 2.35, 2.34, 2.23, 2.18, 2.05, 1.82, 1.76, 1.74, 1.72, 1.7, 1.69, 1.67, 1.62, 1.58, 1.56, 1.49, 1.46, 1.42, 1.4, 1.37, 1.3, 1.28, 1.24, 1.24, 1.2, 1.18, 1.16, 1.16]
...
protein1 = [248, 259, 252, 255, 252, 214, 210, 252, 240] #test data
protein2 = [42, 130, 137, 141, 141, 24, 31, 46, 35]
evscore = [3.4, 1.96, 1.85, 1.79, 1.36, 1.17, 1.16, 1.14, 1.09]
for i in range(len(protein1)): #loops through a list of coev pairs and their scores
...
mc1=IMP.pmi.macros.ReplicaExchange0(mdl,
                                    ...
                                    global_output_directory="/home/cns-mccafferty/Ecoli_CoEv_modeling/CoEv_IMP/1fft/15cutoff/run1/output/")
