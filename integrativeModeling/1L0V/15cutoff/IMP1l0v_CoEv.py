...
protein1 = [226, 163, 92, 203, 12, 100, 165, 226, 96, 138] #test data
protein2 = [94, 12, 10, 29, 10, 5, 32, 87, 23, 75]
evscore = [11.2, 10.2, 9.6, 8.8, 8.1, 7.8, 7.7, 7.6, 7.4, 7.4]
...
protein1 = [37, 116, 33, 7, 120, 77, 87, 37, 47, 34, 91, 33, 27, 121, 31, 5, 27, 50, 113, 117, 31, 31, 38, 124, 14, 113, 73, 75, 7, 64, 117, 68] #test data
protein2 = [79, 27, 83, 77, 27, 107, 23, 83, 57, 83, 23, 86, 86, 31, 85, 77, 90, 52, 23, 27, 86, 90, 73, 31, 66, 27, 37, 71, 13, 9, 84, 50]
evscore = [15.31, 13.85, 13.11, 11.39, 11.33, 10.92, 10.66, 10.6, 10.53, 10.28, 10.19, 10.15, 10.11, 10.04, 9.95, 9.76, 9.69, 9.46, 9.4, 9.28, 9.19, 9.17, 8.85, 8.82, 8.81, 8.78, 8.67, 8.59, 8.57, 8.31, 8.25, 8.22]
for i in range(len(protein1)): #loops through a list of coev pairs and their scores
...
mc1=IMP.pmi.macros.ReplicaExchange0(mdl,
                                    ...
                                    global_output_directory="/home/cns-mccafferty/Ecoli_CoEv_modeling/CoEv_IMP/1l0v/15cutoff/run1/output/")
