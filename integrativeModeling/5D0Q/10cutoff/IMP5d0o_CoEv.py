...
protein1 = [237, 230, 230, 156, 143, 199, 184, 208, 61, 208, 188, 137, 124, 154, 143] #test data
protein2 = [68, 66, 74, 97, 59, 67, 32, 66, 36, 58, 32, 77, 61, 40, 39]
evscore = [2.11, 1.4, 1.37, 1.21, 1.2, 1.19, 1.15, 1.04, 1.04, 1.03, 1.01, 0.99, 0.96, 0.95, 0.94]
for i in range(len(protein1)): #loops through a list of coev pairs and their scores
    coevr1 = IMP.pmi.restraints.basic.DistanceRestraint(representation=None,
...
mc1=IMP.pmi.macros.ReplicaExchange0(mdl,
                                    ...
                                    global_output_directory="/home/cns-mccafferty/Ecoli_CoEv_modeling/CoEv_IMP/5d0q/10cutoff/run1/output/")
