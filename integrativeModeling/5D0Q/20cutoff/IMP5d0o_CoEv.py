...
protein1 = [480, 372, 351, 363, 361, 38, 373, 351, 363, 362, 366, 652, 177, 351, 745, 365, 358, 652, 444, 472, 716, 137, 240, 375, 169, 38, 348, 745, 732, 466, 745, 355, 171, 71, 351, 55, 285, 776, 89, 322, 387, 41, 260, 41, 88, 256, 788, 806, 478, 169, 188, 155, 404, 195, 519, 339, 289, 663, 64, 41, 223] #test data
protein2 = [187, 190, 178, 187, 134, 99, 197, 181, 184, 181, 185, 191, 114, 204, 205, 181, 139, 140, 145, 212, 238, 159, 155, 192, 139, 69, 191, 180, 133, 48, 207, 138, 197, 140, 197, 102, 141, 107, 103, 176, 171, 108, 224, 149, 143, 49, 48, 207, 224, 224, 141, 56, 96, 45, 151, 168, 68, 80, 138, 58, 208]
evscore = [1.73, 1.4, 1.37, 1.34, 1.3, 0.96, 0.96, 0.81, 0.75, 0.75, 0.65, 0.65, 0.62, 0.62, 0.62, 0.61, 0.58, 0.57, 0.55, 0.55, 0.54, 0.54, 0.54, 0.53, 0.53, 0.52, 0.52, 0.52, 0.52, 0.51, 0.51, 0.51, 0.5, 0.5, 0.5, 0.5, 0.49, 0.49, 0.49, 0.49, 0.49, 0.49, 0.49, 0.48, 0.48, 0.48, 0.48, 0.48, 0.48, 0.48, 0.47, 0.47, 0.47, 0.47, 0.47, 0.47, 0.47, 0.47, 0.47, 0.47, 0.46]
...
protein1 = [109, 95, 44, 30, 140] #test data
protein2 = [184, 82, 172, 83, 112]
evscore = [0.38, 0.38, 0.38, 0.31, 0.3]
for i in range(len(protein1)): #loops through a list of coev pairs and their scores
...
protein1 = [237, 230, 230, 225, 227, 156, 143, 199, 184, 208, 61, 208, 188, 225, 137, 154, 225, 143, 203, 199, 195, 192, 192, 230, 84, 114, 109, 190, 190, 195, 203, 188, 234, 233, 202, 48, 53, 242, 205, 190, 224, 38, 172, 208, 242, 42, 107, 106, 226, 108, 192, 74] #test data
protein2 = [68, 66, 74, 89, 90, 97, 59, 67, 32, 66, 36, 58, 32, 78, 77, 40, 76, 39, 67, 39, 64, 63, 83, 64, 84, 31, 45, 34, 50, 65, 58, 30, 68, 66, 84, 104, 47, 87, 64, 32, 89, 76, 79, 56, 102, 39, 68, 36, 88, 76, 76, 64]
evscore = [2.11, 1.4, 1.37, 1.23, 1.22, 1.21, 1.2, 1.19, 1.15, 1.04, 1.04, 1.03, 1.01, 1.01, 0.99, 0.95, 0.94, 0.94, 0.92, 0.83, 0.83, 0.83, 0.83, 0.82, 0.82, 0.82, 0.81, 0.8, 0.79, 0.77, 0.77, 0.77, 0.75, 0.75, 0.74, 0.74, 0.74, 0.74, 0.74, 0.74, 0.73, 0.73, 0.73, 0.72, 0.72, 0.72, 0.71, 0.7, 0.7, 0.7, 0.7, 0.7]
for i in range(len(protein1)): #loops through a list of coev pairs and their scores
    coevr1 = IMP.pmi.restraints.basic.DistanceRestraint(representation=None,
...
mc1=IMP.pmi.macros.ReplicaExchange0(mdl,
                                    ...
                                    global_output_directory="/home/cns-mccafferty/Ecoli_CoEv_modeling/CoEv_IMP/5d0q/20cutoff/run1/output/")
